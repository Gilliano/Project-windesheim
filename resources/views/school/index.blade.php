			...
			<table class="table table-hover">
				...
				@foreach ($schools as $school)
					<tr>
						...
						<td>
							<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#verwijderen{{ $school->id }}">Verwijderen</button>
							<div class="modal fade" id="verwijderen{{ $school->id }}" tabindex="-1" role="dialog">
